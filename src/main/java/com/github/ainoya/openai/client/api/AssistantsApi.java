...
import com.github.ainoya.client.model.AssistantFileObject;
import com.github.ainoya.client.model.AssistantObject;
import com.github.ainoya.client.model.CreateAssistantFileRequest;
...
import com.github.ainoya.client.model.DeleteAssistantFileResponse;
import com.github.ainoya.client.model.DeleteAssistantResponse;
import com.github.ainoya.client.model.DeleteThreadResponse;
import com.github.ainoya.client.model.ListAssistantFilesResponse;
import com.github.ainoya.client.model.ListAssistantsResponse;
import com.github.ainoya.client.model.ListMessageFilesResponse;
...
public class AssistantsApi {
     ...
     */
    public okhttp3.Call listMessagesCall(String threadId, Integer limit, String order, String after, String before, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listMessagesValidateBeforeCall(String threadId, Integer limit, String order, String after, String before, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'threadId' is set
        if (threadId == null) {
            throw new ApiException("Missing the required parameter 'threadId' when calling listMessages(Async)");
        }

        return listMessagesCall(threadId, limit, order, after, before, _callback);
    ...
    public ListMessagesResponse listMessages(String threadId, Integer limit, String order, String after, String before) throws ApiException {
        ApiResponse<ListMessagesResponse> localVarResp = listMessagesWithHttpInfo(threadId, limit, order, after, before);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ListMessagesResponse> listMessagesWithHttpInfo(String threadId, Integer limit, String order, String after, String before) throws ApiException {
        okhttp3.Call localVarCall = listMessagesValidateBeforeCall(threadId, limit, order, after, before, null);
     ...
     */
    public okhttp3.Call listMessagesAsync(String threadId, Integer limit, String order, String after, String before, final ApiCallback<ListMessagesResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listMessagesValidateBeforeCall(threadId, limit, order, after, before, _callback);
        Type localVarReturnType = new TypeToken<ListMessagesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
