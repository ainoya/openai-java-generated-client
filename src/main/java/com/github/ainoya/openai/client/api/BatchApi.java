...
import com.github.ainoya.client.model.CreateBatchRequest;
import com.github.ainoya.client.model.ListBatchesResponse;
...
public class BatchApi {
     ...
     */
    public okhttp3.Call cancelBatchAsync(String batchId, final ApiCallback<Batch> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call listBatchesCall(String after, Integer limit, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listBatchesValidateBeforeCall(String after, Integer limit, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call listBatchesAsync(String after, Integer limit, final ApiCallback<ListBatchesResponse> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call retrieveBatchCall(String batchId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call retrieveBatchValidateBeforeCall(String batchId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'batchId' is set
        if (batchId == null) {
     ...
     */
    public okhttp3.Call retrieveBatchAsync(String batchId, final ApiCallback<Batch> _callback) throws ApiException {
