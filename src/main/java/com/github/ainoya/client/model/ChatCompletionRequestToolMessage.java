...
import com.github.ainoya.client.model.ChatCompletionRequestToolMessageContent;
...
public class ChatCompletionRequestToolMessage {
   ...
   * @return the ChatCompletionRequestToolMessage instance itself
   */
  public ChatCompletionRequestToolMessage putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.role, chatCompletionRequestToolMessage.role) &&
        ...
        Objects.equals(this.additionalProperties, chatCompletionRequestToolMessage.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(role, content, toolCallId, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ChatCompletionRequestToolMessage>() {
           ...
           public ChatCompletionRequestToolMessage read(JsonReader in) throws IOException {
             ...
             ChatCompletionRequestToolMessage instance = thisAdapter.fromJsonTree(jsonObj);
