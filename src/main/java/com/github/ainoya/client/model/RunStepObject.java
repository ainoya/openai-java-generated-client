...
import com.github.ainoya.client.model.RunStepCompletionUsage;
import com.github.ainoya.client.model.RunStepObjectLastError;
import com.github.ainoya.client.model.RunStepObjectStepDetails;
...
public class RunStepObject {
   ...
   * @return the RunStepObject instance itself
   */
  public RunStepObject putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, runStepObject.id) &&
        ...
        Objects.equals(this.additionalProperties, runStepObject.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, _object, createdAt, assistantId, threadId, runId, type, status, stepDetails, lastError, expiredAt, cancelledAt, failedAt, completedAt, metadata, usage, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RunStepObject>() {
           ...
           public RunStepObject read(JsonReader in) throws IOException {
             ...
             RunStepObject instance = thisAdapter.fromJsonTree(jsonObj);
