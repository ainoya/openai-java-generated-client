...
public class FineTune {
  ...
  **/
   ...
   * @return the FineTune instance itself
   */
  public FineTune putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, fineTune.id) &&
        ...
        Objects.equals(this.additionalProperties, fineTune.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, createdAt, events, fineTunedModel, hyperparams, model, _object, organizationId, resultFiles, status, trainingFiles, updatedAt, validationFiles, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FineTune>() {
           ...
           public FineTune read(JsonReader in) throws IOException {
             ...
             FineTune instance = thisAdapter.fromJsonTree(jsonObj);
