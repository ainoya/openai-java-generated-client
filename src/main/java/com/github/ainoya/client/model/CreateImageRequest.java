...
public class CreateImageRequest {
  ...
  **/
   ...
   * @return the CreateImageRequest instance itself
   */
  public CreateImageRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.prompt, createImageRequest.prompt) &&
        ...
        Objects.equals(this.additionalProperties, createImageRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(prompt, model, n, quality, responseFormat, size, style, user, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateImageRequest>() {
           ...
           public CreateImageRequest read(JsonReader in) throws IOException {
             ...
             CreateImageRequest instance = thisAdapter.fromJsonTree(jsonObj);
