...
import com.github.ainoya.client.model.ChatCompletionRequestSystemMessageContent;
...
public class ChatCompletionRequestSystemMessage {
   ...
   * @return the ChatCompletionRequestSystemMessage instance itself
   */
  public ChatCompletionRequestSystemMessage putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.content, chatCompletionRequestSystemMessage.content) &&
        ...
        Objects.equals(this.additionalProperties, chatCompletionRequestSystemMessage.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(content, role, name, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ChatCompletionRequestSystemMessage>() {
           ...
           public ChatCompletionRequestSystemMessage read(JsonReader in) throws IOException {
             ...
             ChatCompletionRequestSystemMessage instance = thisAdapter.fromJsonTree(jsonObj);
