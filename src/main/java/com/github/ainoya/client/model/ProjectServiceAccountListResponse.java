...
public class ProjectServiceAccountListResponse {
   ...
   * @return the ProjectServiceAccountListResponse instance itself
   */
  public ProjectServiceAccountListResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._object, projectServiceAccountListResponse._object) &&
        ...
        Objects.equals(this.additionalProperties, projectServiceAccountListResponse.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectServiceAccountListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectServiceAccountListResponse is not found in the empty JSON string", ProjectServiceAccountListResponse.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProjectServiceAccountListResponse>() {
           ...
           public ProjectServiceAccountListResponse read(JsonReader in) throws IOException {
             ...
             ProjectServiceAccountListResponse instance = thisAdapter.fromJsonTree(jsonObj);
