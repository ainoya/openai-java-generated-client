...
import com.github.ainoya.client.model.ChatCompletionTokenLogprob;
...
public class CreateChatCompletionResponseChoicesInnerLogprobs {
   ...
   * @return the CreateChatCompletionResponseChoicesInnerLogprobs instance itself
   */
  public CreateChatCompletionResponseChoicesInnerLogprobs putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.content, createChatCompletionResponseChoicesInnerLogprobs.content) &&
        ...
        Objects.equals(this.additionalProperties, createChatCompletionResponseChoicesInnerLogprobs.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(content, refusal, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("refusal").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `refusal` to be an array in the JSON string but got `%s`", jsonObj.get("refusal").toString()));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateChatCompletionResponseChoicesInnerLogprobs>() {
           ...
           public CreateChatCompletionResponseChoicesInnerLogprobs read(JsonReader in) throws IOException {
             ...
             CreateChatCompletionResponseChoicesInnerLogprobs instance = thisAdapter.fromJsonTree(jsonObj);
