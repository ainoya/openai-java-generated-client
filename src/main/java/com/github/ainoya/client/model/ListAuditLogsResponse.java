...
import com.github.ainoya.client.model.AuditLog;
...
public class ListAuditLogsResponse {
   ...
   * @return the ListAuditLogsResponse instance itself
   */
  public ListAuditLogsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._object, listAuditLogsResponse._object) &&
        ...
        Objects.equals(this.additionalProperties, listAuditLogsResponse.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAuditLogsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAuditLogsResponse is not found in the empty JSON string", ListAuditLogsResponse.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ListAuditLogsResponse>() {
           ...
           public ListAuditLogsResponse read(JsonReader in) throws IOException {
             ...
             ListAuditLogsResponse instance = thisAdapter.fromJsonTree(jsonObj);
