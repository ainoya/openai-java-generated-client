...
import com.github.ainoya.client.model.FineTuningJobCheckpointMetrics;
...
public class FineTuningJobCheckpoint {
   ...
   * @return the FineTuningJobCheckpoint instance itself
   */
  public FineTuningJobCheckpoint putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, fineTuningJobCheckpoint.id) &&
        ...
        Objects.equals(this.additionalProperties, fineTuningJobCheckpoint.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, createdAt, fineTunedModelCheckpoint, stepNumber, metrics, fineTuningJobId, _object, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FineTuningJobCheckpoint>() {
           ...
           public FineTuningJobCheckpoint read(JsonReader in) throws IOException {
             ...
             FineTuningJobCheckpoint instance = thisAdapter.fromJsonTree(jsonObj);
