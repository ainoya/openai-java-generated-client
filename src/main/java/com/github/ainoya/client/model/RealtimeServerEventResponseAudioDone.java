...
public class RealtimeServerEventResponseAudioDone {
  ...
  public RealtimeServerEventResponseAudioDone type(String type) {
    this.type = type;
    return this;
  }
   ...
   * @return the RealtimeServerEventResponseAudioDone instance itself
   */
  public RealtimeServerEventResponseAudioDone putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.eventId, realtimeServerEventResponseAudioDone.eventId) &&
        ...
        Objects.equals(this.additionalProperties, realtimeServerEventResponseAudioDone.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventId, type, responseId, itemId, outputIndex, contentIndex, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RealtimeServerEventResponseAudioDone.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RealtimeServerEventResponseAudioDone is not found in the empty JSON string", RealtimeServerEventResponseAudioDone.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RealtimeServerEventResponseAudioDone>() {
           ...
           public RealtimeServerEventResponseAudioDone read(JsonReader in) throws IOException {
             ...
             RealtimeServerEventResponseAudioDone instance = thisAdapter.fromJsonTree(jsonObj);
