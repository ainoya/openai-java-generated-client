...
import com.github.ainoya.client.model.CreateFineTuningJobRequestIntegrationsInner;
import com.github.ainoya.client.model.CreateFineTuningJobRequestModel;
...
public class CreateFineTuningJobRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(model, trainingFile, hyperparameters, suffix, validationFile, integrations, seed, additionalProperties);
  }
