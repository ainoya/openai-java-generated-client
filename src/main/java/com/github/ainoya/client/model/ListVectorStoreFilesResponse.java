...
public class ListVectorStoreFilesResponse {
   ...
   * @return the ListVectorStoreFilesResponse instance itself
   */
  public ListVectorStoreFilesResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._object, listVectorStoreFilesResponse._object) &&
        ...
        Objects.equals(this.additionalProperties, listVectorStoreFilesResponse.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListVectorStoreFilesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListVectorStoreFilesResponse is not found in the empty JSON string", ListVectorStoreFilesResponse.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ListVectorStoreFilesResponse>() {
           ...
           public ListVectorStoreFilesResponse read(JsonReader in) throws IOException {
             ...
             ListVectorStoreFilesResponse instance = thisAdapter.fromJsonTree(jsonObj);
