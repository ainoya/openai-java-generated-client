...
public class DoneEvent {
   ...
   * @return the DoneEvent instance itself
   */
  public DoneEvent putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.event, doneEvent.event) &&
        ...
        Objects.equals(this.additionalProperties, doneEvent.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DoneEvent>() {
           ...
           public DoneEvent read(JsonReader in) throws IOException {
             ...
             DoneEvent instance = thisAdapter.fromJsonTree(jsonObj);
