...
public class RunStepStreamEventOneOf1 {
   ...
   * @return the RunStepStreamEventOneOf1 instance itself
   */
  public RunStepStreamEventOneOf1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.event, runStepStreamEventOneOf1.event) &&
        ...
        Objects.equals(this.additionalProperties, runStepStreamEventOneOf1.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RunStepStreamEventOneOf1>() {
           ...
           public RunStepStreamEventOneOf1 read(JsonReader in) throws IOException {
             ...
             RunStepStreamEventOneOf1 instance = thisAdapter.fromJsonTree(jsonObj);
