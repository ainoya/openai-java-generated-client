...
public class RealtimeServerEventResponseTextDone {
  ...
  public RealtimeServerEventResponseTextDone type(String type) {
    this.type = type;
    return this;
  }
   ...
   * @return the RealtimeServerEventResponseTextDone instance itself
   */
  public RealtimeServerEventResponseTextDone putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.eventId, realtimeServerEventResponseTextDone.eventId) &&
        ...
        Objects.equals(this.additionalProperties, realtimeServerEventResponseTextDone.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventId, type, responseId, itemId, outputIndex, contentIndex, text, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RealtimeServerEventResponseTextDone.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RealtimeServerEventResponseTextDone is not found in the empty JSON string", RealtimeServerEventResponseTextDone.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RealtimeServerEventResponseTextDone>() {
           ...
           public RealtimeServerEventResponseTextDone read(JsonReader in) throws IOException {
             ...
             RealtimeServerEventResponseTextDone instance = thisAdapter.fromJsonTree(jsonObj);
