...
public class UserRoleUpdateRequest {
   ...
   * @return the UserRoleUpdateRequest instance itself
   */
  public UserRoleUpdateRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.role, userRoleUpdateRequest.role)&&
        Objects.equals(this.additionalProperties, userRoleUpdateRequest.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserRoleUpdateRequest>() {
           ...
           public UserRoleUpdateRequest read(JsonReader in) throws IOException {
             ...
             UserRoleUpdateRequest instance = thisAdapter.fromJsonTree(jsonObj);
